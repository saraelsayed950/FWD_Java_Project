...
public class MyHeaderTableModel extends DefaultTableModel {
      private String [] colsNames = {"invoiceID","invoiceDate","CustomerName","Total"};
      private ArrayList<MyInvoiceHeader> invoices;
      
      public MyHeaderTableModel(ArrayList<MyInvoiceHeader> invoices) {
    ...
    public Object getValueAt(int row, int column) {
    	MyInvoiceHeader inv = invoices.get(row);
    	switch (column) {
    ...
    public ArrayList<MyInvoiceHeader> getInvoices() {
        return invoices;
    }
